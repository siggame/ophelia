...
module.exports = {
  ...
  STRIPE_PUBLIC_TEST: _.defaultTo(process.env.STRIPE_PUBLIC_TEST, ''),
  STRIPE_SECRET_TEST: _.defaultTo(process.env.STRIPE_SECRET_TEST, ''),
  STRIPE_PUBLIC_LIVE: _.defaultTo(process.env.STRIPE_PUBLIC_LIVE, ''),
  STRIPE_SECRET_LIVE: _.defaultTo(process.env.STRIPE_SECRET_LIVE, ''),
  ...
  LANGUAGES: ['cs', 'cpp', 'java', 'js', 'py', 'lua', 'Human']
}
