...
export default class ButtonRefresh extends React.Component {
  render () {
    const refreshImage = (
      <svg xmlns='http://www.w3.org/2000/svg' style={{cursor: 'pointer', marginLeft: '4vw'}} xlinkHref='http://www.w3.org/1999/xlink' viewBox='0 0 26 26' version='1.1' width='26px' height='26px'>
        <g id='surface1'>
